  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-2.5 lg:py-2.5">
        <NavLink to="/">
          <img className="w-28 lg:ml-4" src={Logo} alt="Logo" />
        </NavLink>
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-3 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/home-page' || pathname.includes('home-page')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/contact-us' || pathname.includes('contact-us')
                }
              >
                {(handleClick, open) => {
                  return (
          ...
          {/* <!-- Others Group --> */}
          <div>
            <p className="mb-4 ml-4 text-xs  text-bodydark2">
             Version 1.0.0
            </p>
